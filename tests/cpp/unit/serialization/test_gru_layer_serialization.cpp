// tests/cpp/unit/serialization/test_gru_layer_serialization.cpp
...
class GRULayerSerializationTest : public ::testing::Test {
protected:
    void SetUp() override {
        layer = std::make_unique<GRULayer>(16, 8, "tanh", "sigmoid", true);
        layer->set_input_shape(8);
        
        input.resize(4, 8);
        input.setRandom();
        
        filename = "test_gru_layer.bin";
    }
...
TEST_F(GRULayerSerializationTest, SaveAndLoad) {
    ...
    GRULayer loaded_layer(16, 8, "tanh", "sigmoid", true);

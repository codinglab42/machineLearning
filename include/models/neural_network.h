...
namespace models {
    ...
    public:
        ...
        // Factory methods con enum (METODO CONSIGLIATO)
        void add_layer(LayerType type, const std::unordered_map<std::string, double>& params);
        
        // Metodi specifici per layer comuni (convenience)
        ...
        // Factory per layer ricorrenti (con enum)
        ...
        void fit(const Eigen::MatrixXd& X, const Eigen::VectorXd& y,
             int epochs = 100, int batch_size = 32, bool verbose = true) override;
    ...
    private:
        ...
        std::vector<layers::BasicCache> forward_cache_;
